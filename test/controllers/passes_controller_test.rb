...
class PassesControllerTest < ActionController::TestCase
  ...
  test "should create pass" do
    assert_difference('Pass.count') do
      post :create, pass: { event_id: @pass.event_id, quantity: @pass.quantity, user_id: @pass.user_id }
    end
  ...
  test "should update pass" do
    patch :update, id: @pass, pass: { event_id: @pass.event_id, quantity: @pass.quantity, user_id: @pass.user_id }
    assert_redirected_to pass_path(assigns(:pass))
  end
